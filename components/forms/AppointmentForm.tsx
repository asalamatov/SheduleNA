...
import { FormFieldType } from './StudentForm';
...
const AppointmentForm = ({
  ...
  const form = useForm<z.infer<typeof AppointmentFormValidation>>({
    ...
    defaultValues: {
      primaryAdmissionsOfficer: appointment
        ? appointment.primaryAdmissionsOfficer
        : '',
    ...
    try {
      if (type === "create" && studentId) {
        const appointmentData = {
          userId,
          student: studentId,
          primaryAdmissionsOfficer: values.primaryAdmissionsOfficer,
        ...
        if (appointment) {
          form.reset();
          router.push(
            `/students/${userId}/new-appointment/success?appointmentId=${appointment?.$id}`
          );
        }
      } else {
